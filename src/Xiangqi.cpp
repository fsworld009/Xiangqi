...
BEGIN_MESSAGE_MAP(CXiangqiApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CXiangqiApp::OnAppAbout)
	// 依據文件命令的標準檔案
...
BOOL CXiangqiApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CXiangqiDoc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架視窗
		RUNTIME_CLASS(CXiangqiView));
	if (!pDocTemplate)
		return FALSE;
